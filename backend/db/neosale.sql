                                                                                                                                                                                                                                            ...
                                                                                                                                                                                                                                            email_notifications BOOLEAN DEFAULT TRUE NOT NULL,
                                                                                                                                                                                                                                                                                     created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
                                                                                                                                                                                                                                                                                                                                       updated_at TIMESTAMP(6) DEFAULT NULL,
                                                                                                                                                                                                                                                                                                                                                                       CONSTRAINT chk_user_phone CHECK (phone_number ~ '^3\d{9}$'
                                                                                                                                                                                                                                                                                                                                                                                                        OR phone_number IS NULL), CONSTRAINT chk_user_identification CHECK (identification ~ '^\d{6,12}$'
                                                                                                                                                                                                                                                                                                                                                                                                                                                                            OR identification IS NULL), CONSTRAINT chk_user_identification_type CHECK (identification_type IN ('CC',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'CE',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'PP')));
...
CREATE TABLE coupons (id SERIAL PRIMARY KEY,
                                                                                                                                                                                                                                                    ...
                                                                                                                                                                                                                                                    created_by INTEGER NOT NULL,
                                                                                                                                                                                                                                                                       created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
                                                                                                                                                                                                                                                                                                                         expires_at TIMESTAMP(6) NOT NULL,
                                                                                                                                                                                                                                                                                                                                                 CONSTRAINT chk_coupon_discount_type CHECK (discount_type IN ('percentage',
                                                                                                                                                                                                                                                                                                                                                                                                              'fixed')), CONSTRAINT chk_coupon_discount_value_positive CHECK (discount_value > 0), CONSTRAINT chk_coupon_discount_value_valid CHECK ((discount_type = 'percentage'
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      AND discount_value > 0
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      AND discount_value <= 100)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     OR (discount_type = 'fixed'
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                         AND discount_value > 0)), CONSTRAINT chk_coupon_dates CHECK (created_at < expires_at));
                                                                                                                                                                                                                                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                 created_by INTEGER NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    updated_at TIMESTAMP(6),
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               updated_by INTEGER NOT NULL,
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  CONSTRAINT chk_product_price CHECK (price > 0), CONSTRAINT chk_product_stock CHECK (stock >= 0), CONSTRAINT chk_product_weight CHECK (weight_grams > 0), CONSTRAINT chk_product_base_discount CHECK (base_discount >= 0
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                       AND base_discount <= 100), CONSTRAINT chk_product_offer_discount CHECK (offer_discount > 0), CONSTRAINT chk_product_offer_dates CHECK ((in_offer = FALSE)
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              OR (in_offer = TRUE
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  AND offer_start_date IS NOT NULL
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  AND offer_end_date IS NOT NULL
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  AND offer_start_date < offer_end_date
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  AND offer_end_date > CURRENT_TIMESTAMP)));
                                                                             ...
                                                                             color_code VARCHAR(7) NOT NULL,
                                                                                                   color VARCHAR(255) NOT NULL,
                                                                                                                      size VARCHAR(25) NOT NULL,
                                                                                                                                       stock INTEGER NOT NULL,
                                                                                                                                                     sku VARCHAR(100),
                                                                                                                                                         price INTEGER, weight_grams INTEGER, active BOOLEAN DEFAULT TRUE NOT NULL,
                                                                                                                                                                                                                          created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
                                                                                                                                                                                                                                                                            updated_at TIMESTAMP(6),
                                                                                                                                                                                                                                                                                       CONSTRAINT chk_variant_stock CHECK (stock >= 0), CONSTRAINT chk_variant_price CHECK (price > 0), CONSTRAINT chk_variant_weight CHECK (weight_grams > 0), CONSTRAINT unq_product_variant UNIQUE(product_id, color_code, size));
                                                                                  ...
                                                                                  subtotal INTEGER NOT NULL,
                                                                                                   created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
                                                                                                                                                     expires_at TIMESTAMP(6),
                                                                                                                                                                CONSTRAINT chk_cart_subtotal CHECK (subtotal >= 0), CONSTRAINT chk_cart_user_or_session CHECK (user_id IS NOT NULL
...
CREATE TABLE payments (id SERIAL PRIMARY KEY,
 ...
 card_token VARCHAR(255),
            acceptance_token TEXT, acceptance_token_auth TEXT, signature_used VARCHAR(255),
 ...
 user_id INTEGER NOT NULL REFERENCES "User"(id), created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
                                                                                                   updated_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
                                                                                                                                                     approved_at TIMESTAMP(6),
                                                                                                                                                                 failed_at TIMESTAMP(6),
                                                                                                                                                                           processor_response JSONB DEFAULT '{}',
                                                                                                                                                                                                            CONSTRAINT chk_payment_amount CHECK (amount_in_cents > 0), CONSTRAINT chk_payment_currency CHECK (currency IN ('COP',
                                                                                                                                                                                                                                                                                                                           'USD')), CONSTRAINT chk_payment_customer_email CHECK (customer_email ~* '^[A-Za-z0-9._%+-]+@[A-Za-z0-9.-]+\.[A-Za-z]{2,}$'), CONSTRAINT chk_payment_phone CHECK (customer_phone ~ '^3\d{9}$'
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            OR customer_phone IS NULL), CONSTRAINT chk_payment_document_type CHECK (customer_document_type IN ('CC',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'CE',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'PP',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'TI',
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               'NIT',
...
CREATE TABLE orders
 ...
 coupon_id INTEGER REFERENCES coupons(id) ON DELETE
     SET NULL,
 ...
 CONSTRAINT chk_order_subtotal CHECK (subtotal > 0), CONSTRAINT chk_order_discount CHECK (discount >= 0), CONSTRAINT chk_order_shipping_cost CHECK (shipping_cost >= 0), CONSTRAINT chk_order_taxes CHECK (taxes >= 0), CONSTRAINT chk_order_total CHECK (total > 0), CONSTRAINT chk_order_coupon_discount CHECK (coupon_discount >= 0));
                                                              ...
                                                              type VARCHAR(255) NOT NULL,
                                                                                provider VARCHAR(255) NOT NULL,
                                                                                                      provider_account_id VARCHAR(255) NOT NULL,
                                                                                                                                       refresh_token TEXT, access_token TEXT, expires_at INTEGER, token_type VARCHAR(255),
                                                                                                                                                                                                             scope VARCHAR(255),
                                                                                                                                                                                                                   id_token TEXT, session_state VARCHAR(255),
                                                                                                                                                                                                                                                created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
                                                                                                                                                                                                                                                                                                  updated_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
                                                                         ...
                                                                         product_id INTEGER NOT NULL REFERENCES products(id) ON DELETE NO ACTION,
                                                                                                                                          quantity INTEGER NOT NULL,
                                                                                                                                                           unit_price INTEGER NOT NULL,
                                                                                                                                                                              color_code VARCHAR(7) NOT NULL,
                                                                                                                                                                                                    size VARCHAR(25) NOT NULL,
                                                                                                                                                                                                                     CONSTRAINT chk_cart_item_quantity CHECK (quantity > 0), CONSTRAINT chk_cart_item_price CHECK (unit_price >= 0));
                                                                                     ...
                                                                                     size VARCHAR(25) NOT NULL,
                                                                                                      product_id INTEGER NOT NULL REFERENCES products(id) ON DELETE NO ACTION,
                                                                                                                                                                       order_id INTEGER NOT NULL REFERENCES orders(id) ON DELETE NO ACTION,
                                                                                                                                                                                                                                    created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
                                                                                                                                                                                                                                                                                      updated_at TIMESTAMP(6),
                                                                                                                                                                                                                                                                                                 CONSTRAINT chk_order_item_price CHECK (price >= 0), CONSTRAINT chk_order_item_quantity CHECK (quantity > 0), CONSTRAINT chk_order_item_subtotal CHECK (subtotal >= 0));
                                                                                                                                                                                                    ...
                                                                                                                                                                                                    updated_at TIMESTAMP(6),
                                                                                                                                                                                                               updated_by INTEGER NOT NULL REFERENCES "User"(id) ON DELETE NO ACTION,
                                                                                                                                                                                                                                                                              user_type VARCHAR(20) DEFAULT 'admin',
                                                                                                                                                                                                                                                                                                            CONSTRAINT chk_order_log_user_type CHECK (user_type IN ('admin',
                                                                                                                                                                                                                                                                                                                                                                    'system')));
               ...
               user_id INTEGER NOT NULL REFERENCES "User"(id) ON DELETE CASCADE,
                                                                        product_id INTEGER NOT NULL REFERENCES products(id) ON DELETE CASCADE,
                                                                                                                                      rating INTEGER NOT NULL,
                                                                                                                                                     comment TEXT, created_at TIMESTAMP(6) DEFAULT CURRENT_TIMESTAMP NOT NULL,
                                                                                                                                                                                                                     updated_at TIMESTAMP(6),
                                                                                                                                                                                                                                CONSTRAINT chk_review_rating CHECK (rating >= 1
                                                                                                                                                                                                                                                                    AND rating <= 5));
...
CREATE INDEX idx_coupon_valid ON coupons(active, expires_at)
WHERE active = TRUE;
...
CREATE INDEX idx_address_default ON addresses(user_id)
...
CREATE INDEX idx_image_primary ON images(product_id)
