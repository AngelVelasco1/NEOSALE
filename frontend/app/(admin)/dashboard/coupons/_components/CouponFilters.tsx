  ...
  return (
    <Card className={FILTER_CARD_CLASS}>
      <div className="space-y-2">
        <div className="relative overflow-hidden rounded-3xl border border-slate-800/50 bg-gradient-to-br from-slate-950 via-slate-900 to-slate-950 p-6 text-white shadow-lg shadow-blue-900/25">
          <div
        ...
        <div className="rounded-3xl border border-slate-200/70 bg-gradient-to-br from-white via-slate-50 to-slate-100 p-4 shadow-sm dark:border-slate-900 dark:from-slate-950/50 dark:via-slate-900/40 dark:to-slate-950/30">
          <div className="grid grid-cols-1 gap-6 md:grid-cols-[2fr_1fr_1fr_1fr]">
            ...
            <div className="space-y-2">
              <Label className="flex items-center gap-2 text-sm font-semibold text-slate-900 dark:text-slate-100">
                <div className="rounded-xl bg-blue-100/70 p-1.5 dark:bg-blue-900/30">
                  <ToggleLeft className="h-3.5 w-3.5 text-blue-600 dark:text-blue-400" />
                </div>
                Estado
              </Label>
              <div className="relative">
                <ToggleLeft className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-blue-400 dark:text-blue-500" />
                <select
                  value={currentFilters.status}
                  onChange={(e) => handleStatusChange(e.target.value)}
                  className="h-11 w-full appearance-none rounded-xl border border-slate-200/60 bg-white/80 pl-10 pr-10 text-sm font-medium text-slate-700 shadow-sm backdrop-blur-sm transition-all hover:border-blue-400/80 hover:bg-white/90 hover:shadow-md focus:border-blue-400 focus:bg-white/95 focus:outline-none focus:ring-2 focus:ring-blue-400/30 disabled:cursor-not-allowed disabled:opacity-50 dark:border-slate-700/60 dark:bg-slate-900/60 dark:text-slate-200 dark:hover:border-blue-500/60 dark:hover:bg-slate-900/70 dark:focus:border-blue-500 dark:focus:bg-slate-900/80"
                  style={{
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Percent className="pointer-events-none absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-purple-400 dark:text-purple-500" />
                <select
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
          <div className="relative overflow-hidden rounded-3xl border border-slate-200/80 bg-white/92 p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/70">
            ...
            <div className="relative space-y-4">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-slate-500 dark:text-slate-400">Estado</p>
                  <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">Filtra cupones activos o expirados.</p>
                </div>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-slate-200/80 bg-white/92 p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/70">
            <div className="pointer-events-none absolute -left-6 bottom-0 h-24 w-24 rounded-full bg-purple-200/50 blur-3xl dark:bg-purple-400/30" aria-hidden="true" />
            <div className="relative space-y-4">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-slate-500 dark:text-slate-400">Tipo de descuento</p>
                  <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">Porcentaje o cantidad fija.</p>
                </div>
          ...
          <div className="relative overflow-hidden rounded-3xl border border-slate-200/80 bg-white/92 p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900/70">
            ...
            <div className="relative space-y-4">
              <div className="flex items-start justify-between">
                <div>
                  <p className="text-[10px] font-semibold uppercase tracking-[0.35em] text-slate-500 dark:text-slate-400">Visibilidad</p>
                  <p className="mt-1 text-sm text-slate-600 dark:text-slate-300">Mostrar solo cupones destacados.</p>
                </div>
        ...
        <div className="rounded-3xl border border-slate-200/80 bg-gradient-to-br from-white via-slate-50 to-slate-100 p-5 shadow-sm dark:border-slate-900 dark:from-slate-950/50 dark:via-slate-900/40 dark:to-slate-950/30">
          <div className="space-y-4">
            <div className="flex items-center gap-2">
              <div className="rounded-xl bg-emerald-100/70 p-1.5 dark:bg-emerald-900/30">
            ...
            <div className="grid gap-3 sm:grid-cols-2">
              <div className="space-y-2.5">
                <Label className="text-sm font-semibold text-slate-900 dark:text-slate-100">Mínimo</Label>
                <Input
                  type="number"
                  placeholder="0"
                  min="0"
              ...
              <div className="space-y-2.5">
                <Label className="text-sm font-semibold text-slate-900 dark:text-slate-100">Máximo</Label>
                <Input
                  type="number"
                  placeholder="100"
                  min="0"
          ...
          <div className="rounded-3xl border border-slate-200/80 bg-gradient-to-r from-slate-50 via-white to-slate-100 p-5 shadow-sm dark:border-slate-900 dark:from-slate-900/70 dark:via-slate-900/40 dark:to-slate-900/20">
            <div className="flex flex-wrap items-center gap-3">
              ...
              {currentFilters.featured !== "all" && (
                <Badge
                  variant="secondary"
                  className={`${FILTER_ACTIVE_BADGE_CLASS} border-yellow-200/70 text-yellow-700 dark:border-yellow-900/50 dark:text-yellow-200`}
                  onClick={() => handleFeaturedChange("all")}
                >
                  <Star className="h-3.5 w-3.5" />
                  <span className="font-medium">Destacado: {currentFilters.featured === "true" ? "Sí" : "No"}</span>
                  <div className="rounded-sm p-0.5 transition-colors group-hover:bg-yellow-100/70 dark:group-hover:bg-yellow-900/40">
                    <X className="h-3 w-3" />
                  </div>
                </Badge>
              )}
