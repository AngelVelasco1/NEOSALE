...
export function ProductReviews({ productId }: ProductReviewsProps) {
    ...
    if (isLoading) {
        return (
            <section className="rounded-3xl bg-linear-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-xl border border-slate-700/50 p-8 mt-8">
    ...
    return (
        <>
            <section className="rounded-3xl bg-linear-to-br from-slate-900/90 to-slate-800/90 backdrop-blur-xl border border-slate-700/50 p-8 shadow-2xl mt-8">
