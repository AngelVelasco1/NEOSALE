  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex flex-wrap gap-3">
        {filters.searchTerm && (
          <Badge variant="secondary" className="bg-gradient-to-r from-slate-600 to-slate-700 text-slate-200 border-slate-500 px-3 py-1.5 rounded-full hover:bg-slate-600 transition-all duration-200 cursor-pointer group">
        ...
        {filters.selectedColors.map((colorCode) => {
          ...
          return (
            <Badge key={colorCode} variant="secondary" className="bg-gradient-to-r from-slate-600 to-slate-700 text-slate-200 border-slate-500 px-3 py-1.5 rounded-full hover:bg-slate-600 transition-all duration-200 cursor-pointer group">
        ...
        {filters.selectedCategories.map((category) => (
          <Badge key={category} variant="secondary" className="bg-gradient-to-r from-slate-600 to-slate-700 text-slate-200 border-slate-500 px-3 py-1.5 rounded-full hover:bg-slate-600 transition-all duration-200 cursor-pointer group">
