...
export default function CartProducts() {
  ...
  const fetchVariantStock = useCallback(async (product: CartProductsInfo) => {
    ...
    try {
      ...
      // ✅ SI LA CANTIDAD ACTUAL EXCEDE EL STOCK, ACTUALIZAR AUTOMÁTICAMENTE
      if (product.quantity > currentStock && currentStock > 0) {
        ...
        // ✅ SI NO HAY STOCK, NOTIFICAR AL USUARIO
  ...
  // ✅ FUNCIÓN PARA OBTENER STOCK ACTUAL DE UNA VARIANTE
