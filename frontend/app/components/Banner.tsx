  ...
  return (
    <section className="relative min-h-screen w-full overflow-hidden">
      <div className="absolute inset-0">
        ...
        <div className="absolute inset-0 bg-[linear-gradient(rgba(71,85,105,0.12)_1px,transparent_1px),linear-gradient(90deg,rgba(71,85,105,0.12)_1px,transparent_1px)] bg-[size:80px_80px] animate-grid-subtle" />
      ...
      <div className="relative z-10 flex min-h-screen items-center justify-center  pt-36 pb-18 my-auto">
        <div className="text-center space-y-12 max-w-6xl mx-auto">
          ...
          {/* Botones CTA */}
          <div
            className={`space-y-8 pt-4 transition-all duration-1000 delay-500 ${isLoaded ? "opacity-100 translate-y-0" : "opacity-0 translate-y-10"
              }`}
          >
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              ...
              >
                <span className="relative z-10 animate-text-shine">COMENZAR AHORA</span>
              ...
              >
                ...
                <span className="ml-2 transition-transform group-hover:translate-x-1 group-hover:scale-110 inline-block animate-arrow-bounce">→</span>
              </Button>
            </div>
            ...
            <div className="flex items-center justify-center gap-16 pt-10">
              <div className="text-center animate-fade-in-up animate-stat-bounce">
                ...
                <div className="text-slate-400 text-sm font-medium mt-1">Usuarios activos</div>
              </div>
              <div className="w-px h-10 bg-gradient-to-b from-transparent via-slate-400/50 to-transparent" />
              <div className="text-center animate-fade-in-up animate-stat-bounce" style={{ animationDelay: "0.1s" }}>
                <div className="text-4xl font-bold bg-gradient-to-r from-purple-400 to-pink-400 bg-clip-text text-transparent">
                  99.9%
                </div>
                <div className="text-slate-400 text-sm font-medium mt-1">Uptime</div>
              </div>
              <div className="w-px h-10 bg-gradient-to-b from-transparent via-slate-400/50 to-transparent" />
              <div className="text-center animate-fade-in-up animate-stat-bounce" style={{ animationDelay: "0.2s" }}>
                <div className="text-4xl font-bold bg-gradient-to-r from-cyan-400 to-blue-400 bg-clip-text text-transparent">
                  24/7
                </div>
                <div className="text-slate-400 text-sm font-medium mt-1">Soporte</div>
              </div>
            </div>
          </div>

          {/* Indicador de scroll */}
          <div className={`pt-4 transition-all duration-1000 delay-700 ${isLoaded ? "opacity-100" : "opacity-0"}`}>
            <div className="flex flex-col items-center gap-4 animate-float-gentle">
              <div className="text-slate-400 text-sm font-medium">Descubre más</div>
      ...
      <style jsx>{`
        /* Animación de gradiente más rápida y visible */
        ...
        @keyframes particle-float {
          ...
          50% { transform: translateY(-150px) translateX(80px); opacity: 0.8; }
        }
        @keyframes expand-smooth {
          0% { width: 0; opacity: 0; }
          100% { width: 8rem; opacity: 0.5; }
        }
        /* Rotación más rápida */
        ...
        @keyframes button-pulse {
          0%, 100% { transform: translateY(0) scale(1); box-shadow: 0 10px 25px -5px rgba(71, 85, 105, 0.25); }
          50% { transform: translateY(-2px) scale(1.02); box-shadow: 0 20px 40px -10px rgba(71, 85, 105, 0.4); }
        }
        @keyframes button-pulse-delayed {
          0%, 100% { transform: translateY(0) scale(1); box-shadow: 0 10px 25px -5px rgba(71, 85, 105, 0.15); }
          50% { transform: translateY(-2px) scale(1.02); box-shadow: 0 20px 40px -10px rgba(71, 85, 105, 0.3); }
        }
        ...
        .animate-gradient-flow-reverse { animation: gradient-flow-reverse 4s ease infinite; }
        .animate-float-smooth { animation: float-smooth 15s ease-in-out infinite; }
        .animate-float-smooth-delayed { animation: float-smooth-delayed 18s ease-in-out infinite; }
        .animate-pulse-smooth { animation: pulse-smooth 3s ease-in-out infinite; }
        .animate-glow-smooth { animation: glow-smooth 2.5s ease-in-out infinite; }
        .animate-glow-smooth-delayed { animation: glow-smooth-delayed 2.5s ease-in-out infinite 0.5s; }
        ...
        .animate-expand-smooth { animation: expand-smooth 1.5s ease-out forwards 0.8s; }
        .animate-spin-smooth { animation: spin-smooth 4s linear infinite; }
        .animate-fade-in { animation: fade-in 1s ease-out forwards 0.6s; }
        .animate-fade-in-up { animation: fade-in-up 1s ease-out forwards 1s; }
        .animate-float-gentle { animation: float-gentle 2.5s ease-in-out infinite; }
        .animate-scroll-bounce { animation: scroll-bounce 2s ease-in-out infinite; }
        .animate-stat-bounce { animation: stat-bounce 3s ease-in-out infinite; }
      `}</style>
    </section>
  )
}
