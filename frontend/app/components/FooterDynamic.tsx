...
export const Footer = () => {
  ...
  const storeName = storeSettings?.store_name || 'NeoSale';
  const storeDescription = storeSettings?.store_description || 'Tu destino de moda y estilo. Encuentra las últimas tendencias con la mejor calidad y servicio.';
  const contactEmail = storeSettings?.contact_email || 'info@tutienda.com';
  const contactPhone = storeSettings?.contact_phone || '+57 300 123 4567';
  const city = storeSettings?.city || 'Bogotá';
  const country = storeSettings?.country || 'Colombia';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
            ...
            <div className="lg:col-span-4 space-y-4">
              ...
              <div className="space-y-2 text-center lg:text-left">
                <a href={`mailto:${contactEmail}`} className="flex items-center justify-center lg:justify-start gap-2 text-gray-200 hover:text-white transition-colors group">
                ...
                <a href={`tel:${contactPhone}`} className="flex items-center justify-center lg:justify-start gap-2 text-gray-200 hover:text-white transition-colors group">
